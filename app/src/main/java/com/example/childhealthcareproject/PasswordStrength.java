...
public enum PasswordStrength {
    ...
    WEAK(R.string.weak, Color.parseColor("#ED1C24")),//red
    MEDIUM(R.string.medium, Color.parseColor("#F7941D")),//orange
    STRONG(R.string.strong, Color.parseColor("#CFC529")),//yellow
    VERY_STRONG(R.string.very_strong, Color.parseColor("#7AAD41"));//green
